...
HWND Win32CreateWindow(HINSTANCE hInstance, const WNDCLASSEX &wndClass, const DWORD& styleEx, const DWORD &style, const char* Title, int Width = CW_USEDEFAULT, int Height = CW_USEDEFAULT, int X = CW_USEDEFAULT, int Y = CW_USEDEFAULT, HWND Parent = 0, LPVOID lpParam = 0);
